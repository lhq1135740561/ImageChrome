...
//        }
    ...
    private fun initData() {
        for (item in 1..10) {
//            val data1 = Data1("Apple$item", R.drawable.ic_launcher_foreground)
//            imageLists.add(data1)
        }

        val manager = StaggeredGridLayoutManager(4, StaggeredGridLayoutManager.VERTICAL)
        main_rv.layoutManager = manager
//        imageAdapter = ImageAdapter(imageLists,this)
        main_rv.adapter = imageAdapter
    }


    private fun initAdapter(id: String, a: String, count: Int) {
